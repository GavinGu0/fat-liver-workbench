...
(function (root, factory) {
  ...
  const MED_RANGES = {
    ...
    alt: { min: 0, max: 5000, unit: 'U/L', label: 'ALT' },
    ast: { min: 0, max: 5000, unit: 'U/L', label: 'AST' },
    ggt: { min: 0, max: 5000, unit: 'U/L', label: 'GGT' },
    tg: { min: 0, max: 100, unit: 'mmol/L', label: '甘油三酯' }
  };
