...
const spec = {
  ...
  paths: {
    ...
    '/patients/{id}/labs': { get: { tags: ['doctor'], summary: '肝功能检验记录', security: [{ bearerAuth: [] }], parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }], responses: { '200': { description: 'ok' } } }, post: { tags: ['doctor'], summary: '录入肝功能检验（仅主管医生）', security: [{ bearerAuth: [] }], responses: { '200': { description: 'ok' } } } },
    ...
    '/nurse/education': { get: { tags: ['nurse'], summary: '宣教素材+推送历史', security: [{ bearerAuth: [] }], responses: { '200': { description: 'ok' } } }, post: { tags: ['nurse'], summary: '批量推送宣教', security: [{ bearerAuth: [] }], responses: { '200': { description: 'ok' } } } },
